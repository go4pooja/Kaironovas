...
import { architecture, demonstrates, benchmark, SHOW_BENCHMARK } from '@/lib/caseStudy'
            ...
            {SHOW_BENCHMARK ? (
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm">
                ...
                <p className="text-sm text-slate-400 leading-relaxed">
                  ...
                  measurements from the Kaironovas Engineering Lab will be published
                  with the completed technical case study.
                </p>
              </div>
            )}
          </motion.div>
